...
import Heart from "../assets/3d/heart_air_balloon.glb";

const HeartModel = () => {
  const heartRef = useRef();
  const [positionY, setPositionY] = useState(-12); // Initial Y-position set to 5
  ...
  return (
    <mesh ref={heartRef} position={[-8,  positionY, 0]} scale={[0.15, 0.15, 0.15]}>
